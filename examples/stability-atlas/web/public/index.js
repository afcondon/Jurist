...
(() => {
  ...
  var parseJson = function(input3) {
    ...
    var pObject = function(i2) {
      return function(acc) {
        var v = peek(i2);
        if (v instanceof Just && (v.value0 === "}" && $$null(acc))) {
  ...
  var phaseLabel = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Atlas.App (line 84, column 14 - line 89, column 79): " + [v.constructor.name]);
  };
        ...
        var project = function(v) {
          return function(t) {
            return function(w) {
              ...
              ;
              throw new Error("Failed pattern match at Atlas.App (line 424, column 19 - line 429, column 8): " + [v.constructor.name]);
            };
          };
        };
          ...
          return for_1(mCanvas)(function(canvas2) {
            return function __do3() {
              ...
              (function() {
                ...
                ;
                throw new Error("Failed pattern match at Atlas.App (line 394, column 5 - line 405, column 22): " + [v.constructor.name]);
              })();
  ...
  var paintBlock = function(spec) {
    return function(block) {
      var verdictColor = function(v) {
        ...
        ;
        throw new Error("Failed pattern match at Atlas.App (line 365, column 3 - line 373, column 118): " + [v.constructor.name]);
      };
    ...
    var notifyMessage = function(listener) {
      return function(ev) {
        return for_1(fromEvent(ev))(function(me) {
          ...
          ;
          throw new Error("Failed pattern match at Atlas.App (line 333, column 7 - line 335, column 28): " + [v.constructor.name]);
        });
      };
    };
    return function(v) {
      ...
      if (v instanceof SocketOpened) {
        return bind12(get2)(function(st) {
          ...
          return discard22(modify_3(function(v12) {
            var $93 = {};
            for (var $94 in v12) {
              if ({}.hasOwnProperty.call(v12, $94)) {
                $93[$94] = v12[$94];
              }
              ;
            }
            ;
            $93.phase = PreviewRunning.value;
            $93.spec = spec;
            $93.blocks = 0;
            $93.serverMs = Nothing.value;
            return $93;
          }))(function() {
        ...
        if (v1 instanceof Right) {
          ...
          if (v1.value0 instanceof SweepDone) {
            return bind12(get2)(function(st) {
              ...
              return modify_3(function(v2) {
                ...
                ;
                $107.phase = Done2.value;
                $107.serverMs = new Just(v1.value0.value0.elapsedMs);
                return $107;
              });
            });
          }
          ...
          if (v1.value0 instanceof TrajFrames) {
            return bind12(modify5(function(s) {
              ...
              ;
              $111.frames = append12(s.frames)(v1.value0.value0.frames);
              return $111;
            }))(function(st) {
              return liftEffect3(paintOrrery(st.frameView)(st.frames)(length(st.frames) - 1 | 0));
            });
          }
          ;
          ...
          ;
          throw new Error("Failed pattern match at Atlas.App (line 259, column 18 - line 275, column 70): " + [v1.value0.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at Atlas.App (line 257, column 24 - line 275, column 70): " + [v1.constructor.name]);
      }
      ;
      if (v instanceof SocketClosed) {
        return modify_3(function(v12) {
          var $121 = {};
          for (var $122 in v12) {
            if ({}.hasOwnProperty.call(v12, $122)) {
              $121[$122] = v12[$122];
            }
            ;
          }
          ;
          $121.phase = SocketLost.value;
          return $121;
        });
      }
      ;
      ...
      if (v instanceof Rerun) {
        return bind12(get2)(function(st) {
          ...
          return discard22(modify_3(function(v12) {
            var $139 = {};
            for (var $140 in v12) {
              if ({}.hasOwnProperty.call(v12, $140)) {
                $139[$140] = v12[$140];
              }
              ;
            }
            ;
            $139.phase = PreviewRunning.value;
            $139.spec = spec;
            $139.blocks = 0;
            $139.serverMs = Nothing.value;
            return $139;
          }))(function() {
            return sendMsg(new RequestSweep(spec));
          });
      ...
      if (v instanceof ToggleFli) {
        return bind12(modify5(function(s) {
          ...
          return discard22(modify_3(function(v12) {
            var $145 = {};
            for (var $146 in v12) {
              if ({}.hasOwnProperty.call(v12, $146)) {
                $145[$146] = v12[$146];
              }
              ;
            }
            ;
            $145.phase = PreviewRunning.value;
            $145.spec = spec;
            $145.blocks = 0;
            $145.serverMs = Nothing.value;
            return $145;
          }))(function() {
            return sendMsg(new RequestSweep(spec));
          });
      ...
      if (v instanceof ToggleFrameView) {
        return bind12(modify5(function(s) {
          ...
          $149.frameView = (function() {
            ...
            ;
            throw new Error("Failed pattern match at Atlas.App (line 311, column 21 - line 313, column 31): " + [s.frameView.constructor.name]);
          })();
          return $149;
        }))(function(st) {
      ...
      if (v instanceof Tick) {
        return bind12(get2)(function(st) {
          ...
          return when2(n > 1 && !st.trajLive)((function() {
            var ix = mod2(st.animIx + max1(1)(div1(n)(450)) | 0)(n);
            return discard22(modify_3(function(v12) {
              var $152 = {};
              for (var $153 in v12) {
                if ({}.hasOwnProperty.call(v12, $153)) {
                  $152[$153] = v12[$153];
                }
                ;
              }
      ...
      ;
      throw new Error("Failed pattern match at Atlas.App (line 234, column 16 - line 323, column 59): " + [v.constructor.name]);
    };
  })();
  var render = function(st) {
    ...
    var selectionText = (function() {
      ...
      ;
      throw new Error("Failed pattern match at Atlas.App (line 218, column 19 - line 222, column 36): " + [st.selection.constructor.name]);
    })();
    ...
    return div2([class_("atlas")])([header_([h1_([text("The Stability Atlas")]), p([class_("thesis")])([text("Each pixel is a real orbit integration of a test asteroid in the Sun\u2013Jupiter three-body problem, computed by PureScript compiled to Julia and streamed here over a typed WebSocket. Dark means the asteroid was lost \u2014 ejected or swept into Jupiter's Hill sphere.")])]), div2([class_("controls")])([label_([text("horizon "), select([onValueChange(SetHorizon.create)])(map15(horizonOption)(["50", "150", "300"])), text(" Jupiter periods")]), button([onClick(function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Atlas.App (line 192, column 27 - line 194, column 58): " + [st.frameView.constructor.name]);
    })())]), span2([class_("drift")])([text(driftText)])]), canvas([id2("orrery-canvas"), width2(420), height2(420)])])]);
  };
  ...
  var evalQ = function(render2) {
    return function(ref3) {
      return function(q2) {
        return bind13(liftEffect5(read(ref3)))(function(v) {
          return evalM(render2)(ref3)(v["component"]["eval"](new Query(map19(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
  ...
  var runUI2 = function(component2) {
    return function(i2) {
      return function(element3) {
        return bind15(liftEffect7(map23(toDocument)(bindFlipped8(document2)(windowImpl))))(function(document3) {
