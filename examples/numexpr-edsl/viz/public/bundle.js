...
(() => {
  ...
  // output/DoublePendulum.Fetch/foreign.js
  var loadTrajectory_ = (url2) => (onError, onSuccess) => {
    fetch(url2).then((r2) => {
      if (!r2.ok) throw new Error("HTTP " + r2.status + " fetching " + url2);
      return r2.json();
    }).then((d2) => onSuccess(d2)).catch((e) => onError(e));
  ...
  // output/DoublePendulum.Fetch/index.js
  var loadTrajectory = function(url2) {
    return fromEffectFnAff(loadTrajectory_(url2));
  };
  ...
  var siblings = function(trees) {
    var $lazy_flatten = $runtime_lazy8("flatten", "Hylograph.HATS", function() {
      ...
      function handlePointerMove(event) {
        ...
        if (svg) {
          ...
          if (ctm) {
            ...
            const scale2 = ctm.a;
            transform.x += event.movementX / scale2;
            transform.y += event.movementY / scale2;
          } else {
    ...
    return (config) => () => {
      ...
      function toSVGDelta(screenDx, screenDy) {
        ...
        if (svg.getScreenCTM) {
          ...
          if (ctm) {
            const scale2 = ctm.a;
            return [screenDx / scale2, screenDy / scale2];
          }
        }
  ...
  var attachCoordinatedBrushThunked = (element3) => (extent) => (groupName) => () => {
    ...
    element3.addEventListener("pointermove", function(event) {
      ...
      const box = { x0: x, y0: y, x1: x + width9, y1: y + height9 };
  ...
  var fromFoldable5 = /* @__PURE__ */ fromFoldable3(foldableArray)(ordString);
            ...
            return function(phaseSpec) {
              return function(idx) {
                ...
                if (phaseSpec.transition instanceof Just) {
                  ...
                  var baseDelay = fromMaybe(0)(map13(unwrap2)(phaseSpec.transition.value0.delay));
                  ...
                  return map22(catMaybes)(traverse2(mkUpdateTransition(el)(duration2)(delay2)(easing))(templateAttrs));
                }
                ;
          ...
          return function(phaseSpec) {
            return function(idx) {
              ...
              if (phaseSpec.transition instanceof Just) {
                ...
                var delay2 = baseDelay + staggerDelay * toNumber(idx);
                var easing = toTickEasing(phaseSpec.transition.value0.easing);
                return map22(catMaybes)(traverse2(mkExitTransition(el)(duration2)(delay2)(easing))(phaseSpec.attrs));
              }
              ;
            ...
            return function(phaseSpec) {
              return function(idx) {
                ...
                if (phaseSpec.transition instanceof Just) {
                  ...
                  var delay2 = baseDelay + staggerDelay * toNumber(idx);
                  var easing = toTickEasing(phaseSpec.transition.value0.easing);
                  return map22(catMaybes)(traverse2(mkEnterTransition(duration2)(delay2)(easing)(templateAttrs))(phaseSpec.attrs));
                }
                ;
                    ...
                    return function(datum) {
                      ...
                      if (itemTree instanceof Elem2) {
                        return function __do2() {
                          ...
                          return {
                            element: el,
                            childSelections: foldl2(union3)(empty2)(map11(function(v) {
                              return v.selections;
                            })(childMaps)),
                            transitions
                          };
            ...
            if (v instanceof MkFold) {
              return runSomeFold(v.value0)(function(foldSpec) {
                ...
                return function __do2() {
                  ...
                  var elements = map11(function(v1) {
                    return v1.element;
                  })(results);
                  var childMaps = foldl2(union3)(empty2)(map11(function(v1) {
                    return v1.childSelections;
                  })(results));
                  return {
                    selections: insert4(foldSpec.name)(elements)(childMaps),
                    entering: [catMaybes(map11(function(v1) {
            ...
            return function(v) {
              ...
              if (v instanceof MkFold) {
                return runSomeFold(v.value0)(function(spec) {
                  ...
                  var newKeys = fromFoldable5(map11(spec.keyFn)(items));
                  ...
                  return function __do2() {
                    ...
                    var existingKeys = fromFoldable5(map11(function(v1) {
                      return v1.key;
                    })(existingKeysAndEls));
                    ...
                    var updateElements = map11(function(v1) {
                      return v1.element;
                    })(filter(function(v1) {
                      return member3(v1.key)(updateKeys);
                    })(existingKeysAndEls));
                    var enterElements = map11(function(v1) {
                      return v1.element;
                    })(enterResults);
                    var childMaps = foldl2(union3)(empty2)(map11(function(v1) {
                      return v1.childSelections;
  ...
  // output/DoublePendulum.Component/index.js
  ...
  var append12 = /* @__PURE__ */ append(semigroupTree);
  ...
  var trailLen = 800;
  var scale = 150;
  var toCanvas = function(x) {
    return function(y) {
      return new Tuple(x * scale, -y * scale);
    };
  };
  var trailD = function(pts) {
    var seg = function(v2) {
      var v1 = toCanvas(v2.value0)(v2.value1);
      return show4(v1.value0) + (" " + show4(v1.value1));
    };
    var v = uncons(pts);
    if (v instanceof Nothing) {
      return "";
    ...
    ;
    if (v instanceof Just) {
      return "M " + (seg(v.value0.head) + foldMap2(function(p2) {
        return " L " + seg(p2);
      })(v.value0.tail));
    }
    ;
    throw new Error("Failed pattern match at DoublePendulum.Component (line 171, column 14 - line 173, column 81): " + [v.constructor.name]);
  };
  var rodColor = "#1c1c1c";
  var renderShell = /* @__PURE__ */ (function() {
    var shell = elem2(SVG.value)([attr2("id")("dp-svg"), class_("dp-svg"), width(720), height(720), viewBox(-360)(-360)(720)(720), attr2("preserveAspectRatio")("xMidYMid meet")])([elem2(Group.value)([attr2("id")("dp-scene")])([])]);
    return $$void6(rerender("#dp-host")(shell));
  })();
  var render = function(v) {
    return div2([id2("dp-host")])([]);
  };
  var pivotColor = "#1c1c1c";
  var capTrail = function(ts) {
    return drop(max6(0)(length(ts) - trailLen | 0))(ts);
  };
  var bob2Color = "#c41e3a";
  var bob1Color = "#1e5a8c";
  var at = function(arr) {
    return function(i2) {
      return fromMaybe(0)(index(arr)(i2));
    };
  };
  var renderScene = function(frame) {
    return function(trail) {
      var v = toCanvas(0)(0);
      var v1 = toCanvas(at(frame)(0))(at(frame)(1));
      var v2 = toCanvas(at(frame)(2))(at(frame)(3));
      var trailEl = elem2(Path.value)([d(trailD(trail)), fill("none"), stroke(bob2Color), strokeWidth(1.4), opacity("0.55")])([]);
      var rod = function(ax) {
        return function(ay) {
          return function(bx) {
            return function(by) {
              return elem2(Line.value)([x1(ax), y1(ay), x2(bx), y2(by), stroke(rodColor), strokeWidth(3)])([]);
            };
          };
        };
      };
        ...
        return function(by) {
          return function(rr) {
            return function(col2) {
              return elem2(Circle.value)([cx(bx), cy(by), r(rr), fill(col2), stroke("#ffffff"), strokeWidth(2)])([]);
            };
          };
        };
      };
      var scene = append12(trailEl)(append12(rod(v.value0)(v.value1)(v1.value0)(v1.value1))(append12(rod(v1.value0)(v1.value1)(v2.value0)(v2.value1))(append12(bob(v.value0)(v.value1)(5)(pivotColor))(append12(bob(v1.value0)(v1.value1)(11)(bob1Color))(bob(v2.value0)(v2.value1)(11)(bob2Color))))));
      return $$void6(rerender("#dp-scene")(scene));
    };
  };
  var handleAction = function(dictMonadAff) {
    ...
    return function(v) {
      if (v instanceof Initialize2) {
        return bind4(liftAff2(loadTrajectory("double-pendulum.json")))(function(traj) {
          return discard2(modify_3(function(v1) {
            ...
            ;
            $59.frames = traj.frames;
            return $59;
          }))(function() {
            return discard2(liftEffect7(renderShell))(function() {
              return handleAction(dictMonadAff)(Tick.value);
            });
          });
        });
      }
      ...
      if (v instanceof Tick) {
        return bind4(get2)(function(st) {
          ...
          return discard2(when2(n > 0)((function() {
            var wrapped = st.idx >= n;
            var idx = (function() {
              if (wrapped) {
                return 0;
              }
            ...
            var frame = fromMaybe([0, 0, 0, 0])(index(st.frames)(idx));
            var bob2 = new Tuple(at(frame)(2), at(frame)(3));
            var baseTrail = (function() {
              if (wrapped) {
                return [];
              }
              ;
            ...
            var trail = capTrail(snoc(baseTrail)(bob2));
            return discard2(modify_3(function(v1) {
              var $64 = {};
              for (var $65 in v1) {
              ...
              return liftEffect7(renderScene(frame)(trail));
            });
          })()))(function() {
            return discard2(liftAff2(delay(16)))(function() {
              return handleAction(dictMonadAff)(Tick.value);
            });
          });
        });
      ...
      ;
      throw new Error("Failed pattern match at DoublePendulum.Component (line 87, column 16 - line 107, column 22): " + [v.constructor.name]);
    };
  };
  ...
  // output/DoublePendulum.Main/index.js
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind(bindAff)(awaitBody)(function(body2) {
    return $$void9(runUI2(component2)(unit)(body2));
  }));
